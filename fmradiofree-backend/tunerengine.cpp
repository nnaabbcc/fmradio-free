...
TunerEngine::TunerEngine(QObject *parent) :
  ...
  , m_needToExit(false)
{
    if (QDBusConnection::sessionBus().registerService("com.nnaabbcc.fmradio") &&
        QDBusConnection::sessionBus().registerObject("/com/nnaabbcc/fmradio", this, QDBusConnection::ExportAdaptors))
    {
